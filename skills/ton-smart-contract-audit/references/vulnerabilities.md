# Common TON smart contract vulnerabilities

A page with security best practices in the official TON documentation: https://docs.ton.org/contract-dev/security
...
- **Replay Attack:**
    ...
    - ALWAYS check for replay attack when you encounter authorization based on signature validation.
      This is usually used for external message, but can be used in internal messages as well.
...
- Documentation of [send action](https://docs.ton.org/foundations/actions/send) modes: https://docs.ton.org/foundations/messages/modes. 
  You should also consider [reserve action](https://docs.ton.org/foundations/messages/modes).
